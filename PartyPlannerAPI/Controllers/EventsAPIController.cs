...
namespace PartyPlannerAPI.Controllers
{
    ...
    public class EventsAPIController : ControllerBase
    {
        ...
        [HttpPost]
        public void Post(string name, string description, Category category, string location, DateTime dateTime, float costs, int availableParticipants, int currentParticipants)
        {
