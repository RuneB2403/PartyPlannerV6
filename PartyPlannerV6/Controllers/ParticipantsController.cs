...
namespace PartyPlannerV6.Controllers
{
    public class ParticipantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ParticipantId,Name")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParticipantId,Name")] Participant participant)
        {
